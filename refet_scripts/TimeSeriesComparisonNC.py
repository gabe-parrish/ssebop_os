...
from ETref_tools.metdata_preprocessor import nc_econet_preprocess

"""Here we compare a bunch of extracted (see BulkComparisonNC_GM_extract) North Carolina Ecological Network sites to
...
gridmet_root = r'Z:\Users\Gabe\refET\NC_EcoNet\NC_GM_extract'
mesonet_root = r'Z:\Users\Gabe\refET\NC_EcoNet\NC_Econet_Reformat'

yearly_output = r'Z:\Users\Gabe\refET\NC_EcoNet\NC_GRIDMET_yearly_compare'
monthly_output = r'Z:\Users\Gabe\refET\NC_EcoNet\NC_GRIDMET_monthly_compare'
daily_output =r'Z:\Users\Gabe\refET\NC_EcoNet\NC_GRIDMET_daily_compare'
if not os.path.exists(daily_output):
    os.mkdir(daily_output)

fig_output = r'Z:\Users\Gabe\refET\NC_EcoNet\NC_figs'
...
for gmp, mp, mn in zip(gridmet_paths, mesonet_paths, names_in_common):
    ...
    m_df = metdata_df_uniformat(m_df_complete_yrs, max_air='max_air_temp', min_air='min_air_temp', avg_air='avg_air_temp',
                         ppt='ppt', solar='sol_rad', maxrelhum='max_rel_hum', minrelhum='min_rel_hum',
