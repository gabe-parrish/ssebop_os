...
# terra_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\AZMET_Terra_NDVI_750_buffer_II.csv'
# aqua_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\AZMET_Aqua_NDVI_750_buffer.csv'
terra_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\AZ_Terra_NDVI_750_buffer_00_12.csv'
aqua_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\AZ_Aqua_NDVI_750_buffer_00_12.csv'

# AZ_names = ['Aguila', 'Bonita', 'Bowie', 'Buckeye', 'Coolidge', '\"Ft.Mohave', 'Harquahala',
#             'Roll', 'Dateland', 'Yuma South', 'Kansas Settlement', 'Yuma Valley', 'San Simon', 'Salome', 'Safford',
#             'Yuma North Gila', 'Maricopa', 'Willcox Bench', 'Yuma Mesa', 'Sahuarita', 'Mohave-2', 'Paloma', 'Mohave-1',
#             'Eloy', 'Queen Creek', 'Marana'] # '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
# AZ_names_extract = ['Aguila', 'Bonita', 'Bowie', 'Buckeye', 'Coolidge', '\"Ft Mohave CA', 'Harquahala',
#             'Roll', 'Dateland', 'Yuma South', 'Kansas Settlement', 'Yuma Valley', 'San Simon', 'Salome', 'Safford',
#             'Yuma North Gila', 'Maricopa', 'Willcox Bench', 'Yuma Mesa', 'Sahuarita', 'Mohave-2', 'Paloma', 'Mohave-1',
#             'Eloy', 'Queen Creek', 'Marana']

AZ_names = ['Harquahala','Yuma South',  'Paloma']
AZ_names_extract =  ['Harquahala','Yuma South',  'Paloma']
...
names = AZ_names
snames = AZ_names_extract

for f, n, sn in zip(files_list, fnames, snames):
    print(f)
    data_dictionary = {}
...
for n in names:
    ...
    with open(os.path.join(r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\united_sites\trueRef_MODIS_NDVI_test\early', f'{n}_arizona_ndvi.csv'), 'w') as wfile:
...
#     ax.set_title(f'MODIS NDVI for {n} Arizona')
#     ax.set_xlabel('Date')
#     ax.set_ylabel('NDVI')
#     plt.show()