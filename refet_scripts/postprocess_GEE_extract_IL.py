...
# terra_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\ICN_Terra_NDVI_750_buffer.csv'
# aqua_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\ICN_Aqua_NDVI_750_buffer.csv'
terra_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\ICN_Terra_NDVI_750_buffer_00_12.csv'
aqua_path_NV = r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\terra_aqua_NDVI_GEE\ICN_Aqua_NDVI_750_buffer_00_12.csv'


# IL_names = ['BBC', 'BRW', 'BVL', 'CMI', 'DEK', 'DXS', 'FAI', 'FRE', 'ICC', 'LLC', 'MON', 'OLN', 'ORR', 'RND',
#             'SFM', 'SIU', 'SNI', 'STC', 'STE']
# IL_names_extract = ['BBC', 'BRW', 'BVL', 'CMI', 'DEK', 'DXS', 'FAI', 'FRE', 'ICC', 'LLC', 'MON', 'OLN', 'ORR', 'RND',
#             'SFM', 'SIU', 'SNI', 'STC', 'STE']
IL_names = ['BVL', 'DEK',  'MON']
IL_names_extract = ['BVL', 'DEK',  'MON']
            ...
            if i == 0:
                ...
                for inx, entry in enumerate(lst):
                    try:
                        ...
                        if entry.startswith('3-Letter I'):
...
for n in names:
    ...
    with open(os.path.join(r'Z:\Users\Gabe\refET\deliverable_june18\analysis_dec1_2020\united_sites\trueRef_MODIS_NDVI_test\early', f'{n}_illinois_ndvi.csv'), 'w') as wfile:
...
#     ax.set_title(f'MODIS NDVI for {n} Illinois')
#     ax.set_xlabel('Date')
#     ax.set_ylabel('NDVI')
#     plt.show()